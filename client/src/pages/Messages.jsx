              ...
              return (
                ...
                >
                  <div className="relative flex-shrink-0">
                    ...
                    />
                    {onlineUsers.some(id => String(id) === String(partnerId)) && (
                      <div className="absolute bottom-0 right-0 w-3.5 h-3.5 rounded-full border-2 border-white bg-green-500 animate-pulse" />
                    )}
                  </div>
