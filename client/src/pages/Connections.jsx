            ...
            <div className="inline-flex flex-wrap items-center border-gray-200 rounded-md p-1 bg-white shadow-sm">
                {
                    dataArray.map((tab) => (
                        <button onClick={() => setCurrentTab(tab.label)}
                            key={tab.label} className={`flex items-center px-3 py-1 text-sm rounded-md transition-colors ${currentTab === tab.label ? "bg-white font-medium text-black" : "text-gray-500 hover:text-black"}`}>
                            ...
                            <div className="flex max-sm:flex-col gap-2 mt-4">
                                ...
                                }
                                {
                                    currentTab === "Following" && (
                                        ...
                                        hover:bg-slate-200 text-black activate:scale-95 transition 
                                        cursor-pointer">
                                            Unfollow
                                        </button>
                                    )
                                ...
                                }
                                {
                                    currentTab === "Connections" && (
                                        ...
                                        hover:bg-slate-200 text-slate-800 activate:scale-95 transition 
