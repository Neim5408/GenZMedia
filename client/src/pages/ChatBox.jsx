...
import { Image, SendHorizontal, ArrowLeft, X, MoreHorizontal } from "lucide-react";
            ...
            messages.map((message, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {message.media_url && (
                      <div className="relative max-w-sm mb-2 group">
                        ...
                        {isOutgoing && (
                          <>
                            <button
                              ...
                              className="absolute right-2 top-2 z-20 rounded-full bg-black/55 p-1.5 text-white opacity-100 transition hover:bg-black/75 md:opacity-0 md:group-hover:opacity-100 cursor-pointer"
                              title="Opsi media"
                            >
