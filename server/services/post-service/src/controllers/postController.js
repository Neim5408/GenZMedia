    ...
    upload(req, res, async (err) => {
        ...
        try {
            ...
            try {
                ...
                console.warn("Gagal broadcast postingan baru:", broadcastErr.message);
            }
...
exports.destroy = async (req, res) => {
  try {
    ...
    // Broadcast real-time delete post event so other clients remove the card instantly
    try {
      const notifUrl = process.env.NOTIFICATION_SERVICE_URL || 'http://localhost:50056';
      await fetch(`${notifUrl}/notification/broadcast`, {
        method: 'POST',
      ...
      console.warn("Gagal broadcast hapus postingan:", broadcastErr.message);
    }
