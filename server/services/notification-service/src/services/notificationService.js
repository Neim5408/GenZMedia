...
const readPostCommentsNotifications = async (userId, postId) => {
  if (!userId || !postId) throw new Error("User ID dan Post ID wajib diisi");
  return await notificationModel.markPostCommentsAsRead(userId, postId);
};

module.exports = { addNotification, fetchUserNotifications, readNotification, readAllNotifications, removeNotification, readPostCommentsNotifications };